    ...
    get html() {
        ...
        <nav class="appFrame-top-bar">
            <div class="appFrame-top-flex-div">
                ...
                <!-- Modal -->
                <div class="appFrame-modal" id="${this._uuid}_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog relative w-auto pointer-events-none mr-1">
                        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                            ...
                            <div
                                ...
                                <button type="button" class="px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight
                                    ...
                                    active:bg-blue-800 active:shadow-lg transition duration-150ease-in-out ml-1">
                                    Log out
                                </button>
