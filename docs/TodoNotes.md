...
- [ ] Engine auto start after reset, even though state == stopped
- [ ] When i clone / add a module it auto starts event though engine state == stopped (Only when cloning from the right click menu)
