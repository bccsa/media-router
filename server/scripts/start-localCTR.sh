...
# ----------------------------------------
    ...
    DISPLAY=:0.0 sudo xinit /bin/chromium-browser --test-type --no-sandbox --start-maximized --start-fullscreen --kiosk --autoplay-policy=no-user-gesture-required  --check-for-update-interval=604800 --window-size=1920,1080 --window-position=0,0 --disable-extensions http://localhost:8081 
fi