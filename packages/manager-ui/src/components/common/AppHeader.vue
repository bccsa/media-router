...
<template>
    <header class="h-12 flex items-center justify-between px-4 shrink-0 bg-card border-b border-border">
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-xs text-muted">{{ socket.connected ? 'Connected' : 'Disconnected' }}</span>
            </div>
